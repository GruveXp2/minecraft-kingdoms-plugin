...
public class NyttårTabCompletion implements TabCompleter {
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String @NotNull [] args) {
        ...
        if (args.length == 1) {
            return List.of("reset_signpost", "start_phase_1", "spawn_outline", "animate_popout", "run_glass", "start_light", "fix_year", "report", "lag_tekst", "register_center", "register_number_center", "run_snowflake", "spawn_circle", "toggle_set_blocks", "rotate_snowflake", "teleportus_vekkus", "animate_number", "delete_circle", "save_positions", "load_positions", "test");
        }
        String oper = args[0];
        switch (oper) {
